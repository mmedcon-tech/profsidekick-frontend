              ...
              interactive lessons with real-time voice support and intelligent content navigation.
               ...
               {isAuthenticated ? (
                 ...
                 <>
                   ...
                   <button
                     onClick={() => router.push('/login')}
                     className="bg-white text-blue-600 px-8 py-4 rounded-lg font-medium border border-blue-600 hover:bg-blue-50 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-colors"
                   >
                     Sign In
                   </button>
                 </>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center p-8 bg-gray-50 rounded-2xl hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-2xl font-semibold text-gray-900 mb-4">Smart Content Analysis</h3>
            ...
            <div className="text-center p-8 bg-gray-50 rounded-2xl hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-2xl font-semibold text-gray-900 mb-4">AI Teaching Assistant</h3>
              <p className="text-gray-600 leading-relaxed">
            ...
            <div className="text-center p-8 bg-gray-50 rounded-2xl hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-2xl font-semibold text-gray-900 mb-4">Enhanced Engagement</h3>
              <p className="text-gray-600 leading-relaxed">
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Upload your presentation and start teaching in minutes. No complex setup or training required.</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <CheckCircle className="w-6 h-6 text-green-600 flex-shrink-0 mt-1" />
                  <div>
                    <h3 className="text-xl font-semibold text-gray-900 mb-2">Natural Voice Interaction</h3>
                    <p className="text-gray-600">Speak naturally to navigate slides, get explanations, and handle student questions seamlessly.</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <CheckCircle className="w-6 h-6 text-green-600 flex-shrink-0 mt-1" />
                  <div>
                    <h3 className="text-xl font-semibold text-gray-900 mb-2">Customizable AI Assistant</h3>
                    <p className="text-gray-600">Configure voice, personality, and teaching style to match your preferences and subject matter.</p>
                  </div>
                </div>
              </div>
            </div>
               ...
               <div className="text-center">
                 {isAuthenticated ? (
                   <>
                     ...
                     <p className="text-gray-600 mb-6">Ready to create your next amazing teaching session?</p>
                     <button
                       onClick={() => router.push('/dashboard')}
                   ...
                   <>
                     ...
                     <p className="text-gray-600 mb-6">Be among the first educators to experience the future of AI-powered teaching.</p>
                     <button
                       onClick={() => router.push('/register')}
                       className="w-full bg-blue-600 text-white px-8 py-4 rounded-lg font-medium hover:bg-blue-700 transition-colors"
                     >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="text-center p-6 bg-gray-50 rounded-2xl hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Alberto Gandolfi</h3>
            ...
            <div className="text-center p-6 bg-gray-50 rounded-2xl hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Eliseo Ferrante</h3>
            ...
            <div className="text-center p-6 bg-gray-50 rounded-2xl hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Hanan Salam</h3>
            ...
            <div className="text-center p-6 bg-gray-50 rounded-2xl hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Assylbek Saduakhassov</h3>
