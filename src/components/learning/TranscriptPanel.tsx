...
export default function TranscriptPanel({
  ...
  return (
    <>
      {/* Mobile-only backdrop — the panel becomes a full-screen overlay below md */}
      <div
        className="fixed inset-0 z-40 bg-black/40 md:hidden"
        onClick={onClose}
        aria-hidden="true"
      />
      <div className="fixed inset-y-0 right-0 z-50 flex w-full shrink-0 flex-col border-border bg-card shadow-2xl transition-all duration-300 ease-in-out sm:w-96 md:static md:z-auto md:w-72 md:border-l md:shadow-none lg:w-80">
