      ...
      <div>
        ...
        <div className="flex gap-2">
          <select
            ...
            className="flex-1 px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary/50 dark:focus:ring-primary/50 focus:border-primary/50 dark:border-primary/50 transition-colors"
            required={required}
            disabled={disabled}
          >
          ...
          {showCreateNew && !disabled && (
            <button
              ...
              className="px-3 py-2 border border-gray-300 rounded-lg hover:bg-gray-50 dark:bg-gray-900 focus:ring-2 focus:ring-primary/50 dark:focus:ring-primary/50 focus:border-primary/50 dark:border-primary/50 transition-colors"
        ...
        {selectedCourse && (
          <div className="mt-2 p-3 bg-primary/5 dark:bg-primary/20 border border-primary/20 dark:border-primary/90 rounded-lg">
            <div className="flex items-start gap-2">
              <BookOpen className="w-4 h-4 text-primary/90 dark:text-primary/40 mt-0.5 flex-shrink-0" />
              <div className="text-sm">
                <div className="font-medium text-primary dark:text-primary/10">
                  {selectedCourse.name}
                </div>
                {selectedCourse.description && (
                  <div className="text-primary/95 dark:text-primary/30 mt-1">{selectedCourse.description}</div>
                )}
                <div className="text-primary/90 dark:text-primary/40 mt-1 space-x-4">
            ...
            <form onSubmit={handleCreateCourse} className="space-y-4">
              ...
              <div className="flex gap-3 pt-4">
                <button
                  ...
                  className="flex-1 px-4 py-2 border border-gray-300 rounded-lg text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:bg-gray-900 focus:ring-2 focus:ring-primary/50 dark:focus:ring-primary/50 transition-colors"
                  disabled={createLoading}
                >
                  Cancel
                </button>
                <button
                  type="submit"
                  className="flex-1 px-4 py-2 bg-primary dark:bg-primary/90 text-white rounded-lg hover:bg-primary/90 dark:hover:bg-primary focus:ring-2 focus:ring-primary/50 dark:focus:ring-primary/50 transition-colors disabled:opacity-50"
                  disabled={createLoading}
                >
