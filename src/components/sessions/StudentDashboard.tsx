...
function CourseCard({ course, onClick }: CourseCardProps) {
  ...
  return (
    <button
      onClick={onClick}
      className="group text-left bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 shadow-sm hover:shadow-md transition-shadow duration-200 overflow-hidden focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#BA984E] flex flex-col h-full"
    >
        ...
        <section>
          {loading ? (
            ...
            <div className="rounded-2xl border border-dashed border-gray-200 dark:border-gray-700 p-12 text-center bg-white">
              ...
              <button
                onClick={refetch}
                className="text-sm text-[#BA984E] hover:text-[#d4af37] font-medium"
              >
                Try again
              </button>
            </div>
