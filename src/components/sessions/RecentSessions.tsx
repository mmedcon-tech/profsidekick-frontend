  ...
  if (loading) {
    return (
      <div className="bg-white rounded-2xl shadow-lg p-8">
        <h3 className="text-2xl font-bold text-gray-900 mb-6 text-center">Your Sessions</h3>
    ...
    return (
      <div className="bg-white rounded-2xl shadow-lg p-8">
        ...
        <div className="text-center py-12">
          ...
          <p className="text-gray-500 text-sm mt-2">Create your first teaching session to get started!</p>
        </div>
      </div>
    );
  }
          ...
          >
            <div className="flex items-start justify-between mb-4">
              <div className="flex-1 min-w-0">
                <h4 className="font-semibold text-gray-900 text-lg truncate group-hover:text-blue-700">
