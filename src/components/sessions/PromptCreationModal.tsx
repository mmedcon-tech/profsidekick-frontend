        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6 overflow-y-auto max-h-[calc(90vh-140px)]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-[#BA984E] focus:border-[#BA984E] transition-colors ${
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <select
                    ...
                    onChange={handleInputChange}
                    className={`w-full pl-10 pr-4 py-3 border rounded-lg focus:ring-2 focus:ring-[#BA984E] focus:border-[#BA984E] transition-colors ${
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#BA984E] focus:border-[#BA984E] transition-colors"
              ...
              {formData.tags && (
                <div className="mt-3 flex flex-wrap gap-2">
                  {parseTagsString(formData.tags).map((tag) => (
                    <span
                      key={tag}
                      className="inline-flex items-center px-3 py-1 rounded-full text-sm bg-[#133221]/10 text-[#133221]"
                    >
                      {tag}
                      <button
                        type="button"
                        onClick={() => handleRemoveTag(tag)}
                        className="ml-2 text-[#BA984E] hover:text-[#133221]"
                      >
                        <X className="w-3 h-3" />
                      </button>
                    </span>
          ...
          <div className="flex gap-3 pt-6 border-t">
            ...
            <button
              type="submit"
              disabled={isSaving}
              className="flex-1 px-6 py-3 bg-[#133221] text-white rounded-lg hover:bg-[#1a442d] focus:outline-none focus:ring-2 focus:ring-[#BA984E] disabled:opacity-50 disabled:cursor-not-allowed transition-colors flex items-center justify-center gap-2"
            >
              {isSaving ? (
                <>
