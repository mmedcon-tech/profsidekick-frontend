...
function CollapsibleSection({ title, isOpen, onToggle, children }: CollapsibleSectionProps) {
  return (
    <fieldset className="space-y-4 p-4 border border-gray-200 dark:border-gray-700 rounded-lg">
      <legend 
        className="text-lg font-semibold text-[#d4af37] px-2 cursor-pointer flex items-center gap-2"
        onClick={onToggle}
      >
        <svg 
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white dark:bg-gray-800 rounded-lg max-w-4xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          {/* Core AI Settings */}
          <fieldset className="space-y-4 p-4 border border-gray-200 dark:border-gray-700 rounded-lg">
            <legend className="text-lg font-semibold text-[#d4af37] px-2">Core AI Settings</legend>
            ...
            <div>
              ...
              <div className="flex items-center gap-2">
                <select 
                  ...
                  className="flex-grow p-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#BA984E] focus:border-[#BA984E]"
                >
                ...
                <button 
                  ...
                  className="p-2 border border-gray-300 rounded-lg hover:bg-gray-100 dark:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-[#BA984E]"
                ...
                >
                  {currentlyPlayingVoice === settings.voice ? (
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5 text-[#BA984E]">
            ...
            <div>
              <div className="flex items-center justify-between mb-1">
                ...
                <button
                  ...
                  className="px-3 py-1 text-sm bg-[#133221]/10 hover:bg-[#133221]/20 text-[#d4af37] rounded-lg transition-colors flex items-center gap-1"
                >
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={5}
                  className={`w-full p-2 border rounded-lg font-mono text-sm focus:ring-2 focus:ring-[#BA984E] focus:border-[#BA984E] ${sessionBehaviorRubricError ? "border-red-400" : "border-gray-300"}`}
          ...
          <div className="flex gap-3 pt-4 border-t">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="flex-1 px-4 py-2 bg-[#133221] text-white rounded-lg hover:bg-[#1a442d] focus:outline-none focus:ring-2 focus:ring-[#BA984E] disabled:opacity-50 disabled:cursor-not-allowed"
            >
