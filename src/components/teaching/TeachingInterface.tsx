  ...
  return (
    <div className="h-screen bg-gray-100 dark:bg-gray-800 flex relative">
      ...
      <div className="w-[80%] bg-white dark:bg-gray-800 flex flex-col">
        {/* Header */}
        <div className="bg-[#133221] text-white p-4 flex justify-between items-center">
      ...
      <div className="w-[20%] bg-gradient-to-b from-slate-50 to-white border-l border-slate-200 flex flex-col">
        ...
        <div className="px-3 py-2 flex items-center gap-2 border-b border-slate-200/50 bg-slate-50 flex-shrink-0">
          ...
          <div className={`w-2 h-2 rounded-full flex-shrink-0 ${
            isAISpeaking ? 'bg-[#133221]/50 animate-pulse' :
        ...
        <div className="flex-1 flex flex-col min-h-0">
          ...
          <div className="flex-1 overflow-y-auto p-3 space-y-3">
            ...
            {currentQuestion && (
              <div className="bg-[#133221]/5 border border-[#BA984E]/30 rounded-lg p-3">
                <p className="text-xs font-semibold text-[#BA984E] mb-1 uppercase tracking-wide">Current Question</p>
                <p className="text-xs text-[#133221] leading-relaxed">{currentQuestion}</p>
              </div>
            )}
            {latestResponse && (
        ...
        <div className="p-4 space-y-3 border-t border-slate-200/50">
          ...
          <button
            ...
            className={`w-full flex items-center justify-center gap-2 py-3 px-4 rounded-xl font-medium text-xs transition-all duration-200 ${
              isAudioEnabled 
                ? "bg-[#133221]/50 text-white shadow-lg shadow-blue-500/25 hover:bg-[#133221] hover:shadow-xl hover:shadow-blue-500/30" 
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 max-w-2xl w-full mx-4 max-h-[90vh] overflow-y-auto">
            ...
            <div className="flex gap-4 justify-end">
              ...
              <button
                ...
                className="bg-[#133221] text-white px-6 py-2 rounded-lg font-medium hover:bg-[#1a442d] focus:ring-2 focus:ring-[#BA984E] focus:ring-offset-2 transition-colors"
              >
                Submit & End Session
              </button>
            </div>
