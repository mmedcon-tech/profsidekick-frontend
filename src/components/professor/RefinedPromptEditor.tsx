    ...
    <div className="space-y-4">
      ...
      <div>
        ...
        <textarea
          ...
          rows={4}
          className="w-full rounded-lg border border-gray-300 px-3 py-2 text-sm text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-[#BA984E] focus:border-[#BA984E]"
        ...
        <>
          <div>
            ...
            <textarea
              ...
              rows={12}
              className="w-full rounded-lg border border-gray-300 px-3 py-2 text-sm text-gray-900 dark:text-gray-100 font-mono focus:ring-2 focus:ring-[#BA984E] focus:border-[#BA984E]"
            />
          </div>
          <button
            type="button"
            onClick={onSave}
            disabled={saving}
            className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-[#133221] text-white font-medium hover:bg-[#1a442d] disabled:opacity-50"
          >
            <Save size={18} />
