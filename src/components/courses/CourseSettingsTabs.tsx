        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full max-w-xs px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#BA984E] focus:border-[#BA984E]"
              ...
              return (
                <button
                  ...
                  className={`py-4 px-1 border-b-2 font-medium text-sm transition-colors flex-shrink-0 ${
                    isActive
                      ? 'border-[#BA984E] text-[#BA984E] dark:text-blue-400'
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              disabled={saving}
              aria-busy={saving}
              className="flex items-center gap-2 bg-[#133221] text-white px-6 py-3 rounded-lg font-medium hover:bg-[#1a442d] disabled:opacity-50 disabled:cursor-not-allowed focus:ring-2 focus:ring-[#BA984E] focus:ring-offset-2 transition-colors"
            >
              {saving ? (
