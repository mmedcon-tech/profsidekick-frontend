    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          disabled={uploading}
          aria-busy={uploading}
          className="flex items-center gap-2 bg-[#133221] text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-[#1a442d] focus:ring-2 focus:ring-[#BA984E] focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed"
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="md:col-span-2">
                ...
                <input
                  ...
                  className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500 focus:ring-2 focus:ring-[#BA984E] focus:border-[#BA984E]"
                  required
                />
              </div>
            ...
            <div className="flex items-center justify-end gap-3 pt-4 border-t border-gray-200 dark:border-gray-700">
              ...
              <button
                ...
                disabled={uploading}
                aria-busy={uploading}
                className="flex items-center gap-2 px-4 py-2 bg-[#133221] text-white rounded-lg hover:bg-[#1a442d] focus:ring-2 focus:ring-[#BA984E] focus:ring-offset-2 disabled:opacity-50"
              >
                {uploading ? (
                  <>
      ...
      <div className="space-y-4">
        {materials.length === 0 ? (
          <div className="text-center py-8">
            ...
            <button
              onClick={() => setShowForm(true)}
              className="text-[#BA984E] hover:text-[#d4af37] font-medium"
            >
                ...
                <div className="flex items-center gap-2">
                  {material.url && (
                    <a
                      ...
                      className="p-2 text-gray-500 dark:text-gray-400 hover:text-[#BA984E] rounded-lg hover:bg-[#133221]/5"
                      title="Open link"
                    >
